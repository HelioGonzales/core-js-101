...
function isLeapYear(date) {
  ...
  return (dateFull % 4 === 0) && (dateFull % 100 !== 0 || dateFull % 400 === 0);
}
...
function timeSpanToString(startDate, endDate) {
  ...
  // const endDate1 = new Date(endDate).getTime();
  ...
  return `${hours.toString(10).padStart(2, '0')}:${mins
    .toString(10)
    .padStart(2, '0')}:${seconds.toString(10).padStart(2, '0')}.${miliSeconds
    .toString(10)
    .padStart(3, '0')}`;
}
